...
function przyklad_wlasny_3(x,y,z){
    ...
    if(x===1){
      ...
      document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n}\\cdot`+x+`}{(`+y+`n+`+y+`)!} \\cdot \\frac{(`+y+`n)!}{`+x+`^n} = \\frac{(`+y+`n)!}{(`+y+`n+`+y+`)!}$<br><br>`;
      document.getElementById("przyk").innerHTML += ` $\ \\frac{(`+y+`n)!}{(`+y+`n+`+y+`)!} < 1$<br>`
      MathJax.typeset();
...
function przyklad_wlasny_4(x,y,z){
    ...
    if(x===1){
      ...
      document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n}\\cdot`+x+`}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!} \\cdot \\frac{(`+y+`\\cdot n`+znak+``+z+`)!}{`+x+`^n} = \\frac{(`+y+`\\cdot n`+znak+``+z+`)!}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!}$<br><br>`;
      document.getElementById("przyk").innerHTML += ` $\ \\frac{(`+y+`\\cdot n`+znak+``+z+`)!}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!} < 1$<br>`
      MathJax.typeset();
...
function przyklad_wlasny_5(x,y,z){
    ...
    if(x>0){
      ...
      document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n}\\cdot`+x+`}{(n+1)!} \\cdot \\frac{(n)!}{`+x+`^n} = \\frac{`+x+`\\cdot (n)!}{(n+1)!}$<br><br>`;
      document.getElementById("przyk").innerHTML += ` $\ \\frac{`+x+`\\cdot (n)!}{(n+1)!} < 1$<br>`
      MathJax.typeset();
...
function przyklad_wlasny_6(x,y,z){
    if(x<0){
      ...
      document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n}\\cdot`+x+`}{(n`+znakplus+``+(zplus)+`)!} \\cdot \\frac{(n`+znak+``+z+`)!}{`+x+`^n} = \\frac{`+x+`(n`+znak+``+z+`)!}{(n`+znakplus+``+(zplus)+`)!}$<br><br>`;
      document.getElementById("przyk").innerHTML += ` $\ \\frac{`+x+`(n`+znak+``+z+`)!}{(n`+znakplus+``+(zplus)+`)!} < 1$<br>`
      MathJax.typeset();
...
function przyklad_wlasny_7(x,y,z){
  ...
  document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n}\\cdot`+x+`}{(`+y+`\\cdot n+`+y+`)!} \\cdot \\frac{(`+y+`\\cdot n)!}{`+x+`^n} = \\frac{`+x+`(`+y+`\\cdot n)!}{(`+y+`\\cdot n+`+y+`)!}$<br><br>`;
  document.getElementById("przyk").innerHTML += ` $\ \\frac{`+x+`(`+y+`\\cdot n)!}{(`+y+`\\cdot n+`+y+`)!} < 1$<br>`
  MathJax.typeset();
...
function przyklad_wlasny_8(x,y,z){
    ...
    if(zplus===0){
      ...
      document.getElementById("przyk").innerHTML += ` $\ \\frac{a_{n+1}}{a_n}$`;
      document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n+1}}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!} \\cdot \\frac{(`+y+`\\cdot n`+znak+``+z+`)!}{`+x+`^n}$`;
      document.getElementById("przyk").innerHTML += ` $\ = \\frac{`+x+`^{n}\\cdot`+x+`}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!} \\cdot \\frac{(`+y+`\\cdot n`+znak+``+z+`)!}{`+x+`^n} = \\frac{`+x+`(`+y+`\\cdot n`+znak+``+z+`)!}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!}$<br><br>`;
      document.getElementById("przyk").innerHTML += ` $\ \\frac{`+x+`(`+y+`\\cdot n`+znak+``+z+`)!}{(`+y+`\\cdot n`+znakplus+``+(zplus)+`)!} < 1$<br>`
      MathJax.typeset();
